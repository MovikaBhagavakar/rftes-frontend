    ...
    <div style={{ marginTop: "150px" }} className="cls" >
     ...
     <h1 className="text-align center">Your Thoght</h1>
          <form className="form-horizontal">
            ...
            Title:
            <br></br>
            <input type="text" className="form-control" placeholder="Your Title" value={title} onChange={(e)=>setTitle(e.target.value)}></input>
            </div>
            <div className="area">
            Description:
            <br></br>
            <textarea  className="form-control "   placeholder="Your Description" cols={50} rows={10} value={description} onChange={(e)=>setDescription(e.target.value)} ></textarea>
            </div>
            <div className="area">
          ...
          <button type="button" className="btn btn-primary area area1" style={{marginLeft:'20px'}}>Clear</button>
